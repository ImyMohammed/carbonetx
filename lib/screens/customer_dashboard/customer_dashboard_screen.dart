                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Align(
                      alignment: Alignment.bottomLeft,
                      child: Text(
                        dashboardSubtitles[0],
                        style: kDashSubtitle(width * 0.04),
                      ),
                    ),
                  )
                ],
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              Center(child: Text('Dashboard', style: kPageTitle)),
              Padding(
